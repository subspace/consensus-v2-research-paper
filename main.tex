...
Also, we need to consider more general attacks because the attacking goal here is to minimize the cost instead of the conventional space-time tradeoff.

{\bf Proof Sketch:} To be written.
